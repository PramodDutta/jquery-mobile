...
<div data-role="footer" data-position="fixed" class="<?php echo $siteName; ?>">
	<h4>
		<a href="<?php echo $feed->guid->content;?>" data-icon="forward">Read on <?php echo ucWords($siteName); ?>+</a></h4>
</div>
